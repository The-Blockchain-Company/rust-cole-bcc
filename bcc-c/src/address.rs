...
///
#[no_mangle]
pub extern "C" fn bcc_address_is_valid(c_address: *mut c_char) -> c_int {
...
#[no_mangle]
pub extern "C" fn bcc_address_new_from_pubkey(
    c_xpubkey: XPubPtr,
...
#[no_mangle]
pub extern "C" fn bcc_address_delete(c_addr: AddressPtr) {
    unsafe { Box::from_raw(c_addr) };
}

#[no_mangle]
pub extern "C" fn bcc_address_import_base58(c_address: *mut c_char) -> AddressPtr {
    let address_base58 = unsafe { ffi::CStr::from_ptr(c_address).to_bytes() };
    if let Ok(address_raw) = base58::decode_bytes(address_base58) {
...
#[no_mangle]
pub extern "C" fn bcc_address_export_base58(c_addr: AddressPtr) -> *const c_char {
