...
//! ```
//! # extern crate bcc;
//! use bcc::bip::bip44::{Account, Change, Addressing};
//!
...
/// the BIP44 coin type is set, by default, to bcc ada.
...
impl Addressing {
    ...
    ///
    /// ```
    /// use bcc::bip::bip44::{Addressing, AddrType};
    ///
    ...
    ///
    /// ```
    /// use bcc::bip::bip44::{Addressing, AddrType, Index};
    ///
    /// let addr = Addressing::new(0, AddrType::External, 0).unwrap();
    ///
