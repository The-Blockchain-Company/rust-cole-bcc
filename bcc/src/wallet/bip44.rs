...
impl Account<XPrv> {
    ...
    ///
    /// ```
    /// # use bcc::wallet::{bip44::{self, AddrType}, scheme::{Wallet}};
    /// # use bcc::bip::bip39::{MnemonicString, dictionary::ENGLISH};
    /// # use bcc::address::ExtendedAddr;
    /// # use bcc::util::base58;
    /// # use bcc::config::{NetworkMagic};
    ///
