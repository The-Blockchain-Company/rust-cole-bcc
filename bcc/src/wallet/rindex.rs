...
impl Wallet {
    ...
    /// Compatibility with klarity mnemonic addresses
    ///
    ...
    /// this function.
    pub fn from_klarity_mnemonics<D>(
        derivation_scheme: DerivationScheme,
        dic: &D,
    ...
    {
        let root_key = RootKey::from_klarity_mnemonics(derivation_scheme, dic, mnemonics_phrase)?;
...
impl RootKey {
        ...
        D: bip39::dictionary::Language,
    {
        ...
        let xprv = XPrv::generate_from_klarity_seed(&seed);
...
mod test {
    ...
    lazy_static! {
        ...
        static ref ADDRESSES: Vec<ExtendedAddr> = {
            let mut wallet = rindex::Wallet::from_klarity_mnemonics(
                DerivationScheme::V1,
    ...
    fn test_move_rindex_wallet() {
        let wallet = rindex::Wallet::from_klarity_mnemonics(
            DerivationScheme::V1,
            &bip39::dictionary::ENGLISH,
            MNEMONICS,
        )
