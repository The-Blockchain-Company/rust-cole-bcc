pub mod net {
    use bcc::block::{EpochId, HeaderHash};
    ...
    const NTT_PREFIX: &'static str = r"x-bcc-ntt://";
    ...
    /// ## Http
    ///
    /// Here we expect to connect to [Hermes](https://github.com/the-blockchain-company/bcc-rust)
    ...
    ///
    /// let http_peer = Peer::new("http://hermes.blockchain-company.io".to_string());
    /// assert!(http_peer.is_http());
    ///
    /// let native_peer = Peer::new("mainnet.blockchain-company.io".to_string());
    ...
    impl Config {
        pub fn mainnet() -> Self {
            ...
            peers.push(
                "tbco-hosts".to_string(),
                Peer::native("relays.bcc-mainnet.blockchain-company.io:3000".to_string()),
            );
            peers.push(
                "hermes".to_string(),
                Peer::http("http://hermes.dev.dev.blockchain-company.io.io/mainnet".to_string()),
            );
            Config {
        ...
        pub fn staging() -> Self {
            ...
            peers.push(
                "tbco-hosts".to_string(),
                Peer::native("relays.awstest.dev.blockchain-company.io.io:3000".to_string()),
            );
            peers.push(
                "hermes".to_string(),
                Peer::http("http://hermes.dev.dev.blockchain-company.io.io/staging".to_string()),
            );
            Config {
                genesis: HeaderHash::from_str(
        ...
        pub fn testnet() -> Self {
            ...
            peers.push(
                "tbco-hosts".to_string(),
                Peer::native("relays.bcc-testnet.dev.blockchain-company.io.io:3000".to_string()),
            );
            peers.push(
                "hermes".to_string(),
                Peer::http("http://hermes.dev.dev.blockchain-company.io.io/testnet".to_string()),
            );
            Config {
                genesis: HeaderHash::from_str(
